...
import neth.iecal.questphone.core.utils.managers.getKeyboards
...
class AppBlockerService : Service() {
    ...
    private fun updateTimerNotification(packageName: String, progress: Float, remainingSeconds: Long) {
        try {
            ...
            val channel = notificationManager.getNotificationChannel(neth.iecal.questphone.core.services.NOTIFICATION_CHANNEL_ID)
            if (channel != null) {
